    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center' }}>
            <View style={StylesHomeSettings.mainContainer}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('InfoUserSCreen', {User:UserD?.doctor.data})}>
                    <LinearGradient
                        colors={['#00668C', '#D4EAF7']}
                        start={{ x: 1, y: 1 }}
                        end={{ x: 0, y: 0 }}
                    ...
                    >
                        ...
                        <View style={{ height:'100%', marginHorizontal:10}}>
                            ...
                            <Text  style={{ color: '#FFFEFB', fontSize:19 }}>{"Dr. " + UserD?.doctor.data.Nombre}</Text>
                        </View>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
